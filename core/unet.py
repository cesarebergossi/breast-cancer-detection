'''
u net model implementation taken from:
...
class DoubleConv(nn.Module):
    '''
    2x: unpadded convolution -> BN -> ReLU
    '''
...
class Up(nn.Module):
    '''
    Upscaling then double conv and concat with another tensor
    '''
...
class OutConv(nn.Module):
    '''
    last convolution, no BN, no Relu, i.e. logits.
    '''
    def __init__(self, in_channels, out_channels):
